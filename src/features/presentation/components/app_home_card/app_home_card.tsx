import {Dimensions, ImageBackground, ImageSourcePropType, View} from 'react-native';
...
interface Props {
    match: Match;
    backgroudImage: ImageSourcePropType;
  }

const AppHomeCard = ({match, backgroudImage}: Props) => {
    ...
    <View style={styles.cardContainer}>
      ...
      >
        <View style={styles.textContainer}>
            <AppText size="md" style={{color: '#F2F6FF'}}>{'Es hora de '}</AppText>
            <AppText bold size="lg" style={{color: '#00E096',textShadowColor: 'rgba(0, 224, 150, 0.5)',
         textShadowOffset: {width: -1, height: 1},
         textShadowRadius: 10}}>{'Jugar un partido'}</AppText>
        </View>
